<x-app-layout>
    <x-slot:header>
        ...
        <form action="/ar-create" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                            ...
                            <div class="row mb-4 p-0">
                                <div class="col-xl">
                                    ...
                                    <div class="form-row d-flex align-items-center">
                                        ...
                                        <div class="col-xl-5 mb-2 pr-2">
                                            <label class="label1" for="customerSelect">Customer</label>
                                            <div class="dropdown">
                                                <input type="text" name="customer" class="form-control" id="dropdownInput" onfocus="toggleDropdown(true)" onblur="toggleDropdown(false)" autocomplete="off" value="{{ old('customer')}}" required>
                                                <div class="dropdown-menu m-0" id="dropdownMenu" style="width: 100%;">
                                                    <!-- Modal trigger -->
                                                    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#accountsModal" >Create New Customer</a>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                            ...
                                            <input type="date" name="start_date" class="form-control" id="startDate" onchange="calculateDueDate()" required>
                                ...
                                <table class="table table-striped" id="calculationTable">
                                    ...
                                    <tbody id="servicesTableBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="left"><input type="text" name="services[0][description]" id="description" class="form-control"autocomplete="off" required>
                                                <x-error name="services.0.description"/></td>
                                            <td class="right"><input type="text" name="services[0][amount]" id="amount" class="form-control amount" oninput="calculateResult()" autocomplete="off" required>
                                                <x-error name="services.0.amount"/></td>
                                            <td class="center"><input type="number" name="services[0][quantity]" id="qty" class="form-control quantity" value="1" oninput="calculateResult()"autocomplete="off" min="1" required></td>
